...
// TODO:  line 237  - (p as any).msMatchesSelector error as element is not strongly typed
...
export class DomHandler {
  ...
  public relativePosition(element: any, target: any): void {
    ...
    if (targetOffset.left + elementDimensions.width > viewport.width) left = targetWidth - elementDimensions.width;
    else left = 0;
